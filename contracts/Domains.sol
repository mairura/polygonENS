...
contract Domains is ERC721URIStorage {
    ...
    constructor (string memory _tld) payable ERC721("Mairura Name Service", "MNS") {
        tld = _tld;
    ...
    function register(string calldata name) public payable {
        ...
        string memory json = Base64.encode(
            ...
            _name,
            '", "description": "A domain on the Mairura name service", "image": "data:image/svg+xml;base64,',
